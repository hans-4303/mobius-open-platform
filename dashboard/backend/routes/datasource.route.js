...
router.put("/:datasourceId/run", (req, res, next) => {
  ...
  datasourcesManager
    .runDatasource(auth.parsed, datasourceId, triggerInfo)
    .then((datasource) => {
...
router.put("/:datasourceId/stop", (req, res, next) => {
  ...
  datasourcesManager
    .stopDatasource(auth.parsed, datasourceId)
    .then((datasource) => {
      res.status(200).json(datasource);
    })
    .catch((ex) => {
...
router.put("/:datasourceId", (req, res, next) => {
  ...
  datasourcesManager
    .updateDatasource(auth.parsed.userId, datasourceId, updateData)
    .then((datasource) => {
      res.status(200).json(datasource);
    })
    .catch((ex) => {
...
router.delete("/:datasourceId", (req, res, next) => {
  ...
  datasourcesManager
    .deleteDatasource(auth.parsed.userId, datasourceId)
    .then((datasource) => {
      res.status(200).json(datasource);
    })
    .catch((ex) => {
...
router.post("/", (req, res, next) => {
  ...
  datasourcesManager
    .createDatasource(auth.parsed.userId, datasourceInfo)
    .then((datasource) => {
      res.status(200).json(datasource);
    })
    .catch((ex) => {
...
router.get("/:datasourceId", (req, res, next) => {
  ...
  datasourcesManager
    .getDatasource(auth.parsed, datasourceId)
    .then((datasource) => {
      res.status(200).json(datasource);
    })
    .catch((ex) => {
