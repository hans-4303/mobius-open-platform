...
DatasourceModel.statics.createDatasource = function (
  owner,
  datasourceType,
  description,
  status,
...
DatasourceModel.statics.upsertDatasource = function (
  owner,
  datasourceId,
  updateData
) {
...
// update or create Things document
DatasourceModel.statics.deleteDatasourceDocument = function (
  owner,
  datasourceId
) {
  return new Promise((resolve, reject) => {
