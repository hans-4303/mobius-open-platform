...
router.delete("/:deviceId/resource", function (req, res) {
  ...
  deviceManager
    .deleteDeviceResource(req.user, deviceId)
...
router.put("/:deviceId/acpi", function (req, res) {
  ...
  deviceManager
    .updateDeviceAcpi(req.user, req.params.deviceId, acpi)
...
router.delete("/:deviceId/acpi", function (req, res) {
  ...
  deviceManager
    .updateDeviceAcpi(req.user, req.params.deviceId, acpi, true)
...
router.get("/:deviceId", function (req, res) {
  deviceManager
    .getDeviceInfo(req.user, req.params.deviceId)
...
router.delete("/:deviceId", function (req, res) {
  ...
  deviceManager
    .unregisterDevice(req.user, deviceId)
...
router.put("/:deviceId", function (req, res) {
  ...
  deviceManager
    .updateDeviceInfo(req.user, req.params.deviceId, deviceInfo)
...
router.post("/", function (req, res) {
  deviceManager
    .registerDevice(req.user, req.body)
