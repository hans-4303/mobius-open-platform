(function () {
  ...
  function AlertService($state, toastr) {
    ...
    function __getMessage(err) {
      ...
      if (typeof err === "string") {
        ...
        if (errorMesg === "") errorMesg = err.toString();
      }
  ...
  function config(
    ...
    $breadcrumbProvider.setOptions({
      ...
      template:
        '<li class="breadcrumb-item" ng-repeat="step in steps" ng-class="{active: $last}" ng-switch="$last || !!step.abstract"><a ng-switch-when="false" href="{{step.ncyBreadcrumbLink}}">{{step.ncyBreadcrumbLabel}}</a><span ng-switch-when="true">{{step.ncyBreadcrumbLabel}}</span></li>',
    });
