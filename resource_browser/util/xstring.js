...
var XString = {
  ...
  ellipsis: function (s, n) {
    ...
    if (n !== parseInt(n, 10) || n <= 0) return s;
  ...
  isCSSColorValue: function (s) {
    var CSS_COLOR_PATTERN_REGEX =
      "#(?:[a-f\\d]{6}|[a-f\\d]{3})|" + // #FFFFFF or #FFF
  ...
  removeTailingSlash: function (s) {
    if (s.endsWith("/")) return s.substr(0, s.length - 1);
    else return s;
  },
};
