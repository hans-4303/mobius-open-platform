(function () {
    ...
    $scope.history = [
      {
        ...
        connecto: [
          {
            host: "http://203.253.128.161:7575",
            resources: ["/Mobius/device1", "/Mobius/device2"],
          },
          {
            host: "http://203.253.128.161:7575",
            resources: ["/Mobius/device1", "/Mobius/device2"],
  ...
  function run($rootScope, $location, resmonService) {
    resmonService.getSysInfo().then(function (info) {
    ...
    else window.runningPlatform = "web";
